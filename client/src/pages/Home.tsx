...
export default function Home() {
  ...
  return <div className={`app-shell ${theme === "light" ? "light-mode" : ""}`}>
    <aside className="sidebar">
      ...
      <div className="side-bottom"><div className="security-note"><ShieldCheck size={18} /><div><strong>Local first</strong><span>Your addresses never leave this device.</span></div></div><a className="sidebar-byline" href="https://x.com/amiraphist" target="_blank" rel="noreferrer">A project by @amiraphist ↗</a><div className="version">BUILD 0.1.1 <span>●</span> READY</div></div>
    </aside>
